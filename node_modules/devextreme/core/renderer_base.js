...
var initRender = function(selector, context) {
    ...
    if ("string" === typeof selector) {
        ...
        if ("<" === selector[0]) {
            this[0] = domAdapter.createElement(selector.slice(1, -1), void 0, context);
            this.length = 1;
            return this
        ...
        if (selector.nodeType) {
            ...
            if (selector instanceof HTMLCollection || selector instanceof NodeList || Array.isArray(selector)) {
...
["width", "height", "outerWidth", "outerHeight", "innerWidth", "innerHeight"].forEach(function(methodName) {
    ...
    initRender.prototype[methodName] = function(value) {
        ...
        if (element.nodeType === Node.DOCUMENT_NODE) {
            ...
            return Math.max(element.body["scroll" + partialName], element.body["offset" + partialName], documentElement["scroll" + partialName], documentElement["offset" + partialName], documentElement["client" + partialName])
        }
...
initRender.prototype.filter = function(selector) {
    ...
    for (var i = 0; i < this.length; i++) {
        var item = this[i];
        if (item.nodeType === Node.ELEMENT_NODE && "string" === typeUtils.type(selector)) {
            matches(item, selector) && result.push(item)
        } else {
            if (selector.nodeType || typeUtils.isWindow(selector)) {

...
var DateBox = DropDownEditor.inherit({
    ...
    _getPickerTypeByDeprecatedOptions: function(userOptions) {
        return userOptions.pickerType ? userOptions.pickerType : typeUtils.isDefined(userOptions.useCalendar) || typeUtils.isDefined(userOptions.useNative) ? this._getPickerType() : this._pickerType || this.option("pickerType")
    },

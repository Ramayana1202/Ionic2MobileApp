...
var DEFAULT_DATA_TYPE = "string",
    ...
    AVAILABLE_FIELD_PROPERTIES = ["caption", "customizeText", "dataField", "dataType", "editorTemplate", "falseText", "editorOptions", "filterOperations", "format", "lookup", "trueText"];
...
function getNormalizedFields(fields) {
    return fields.reduce(function(result, field) {
        if ("undefined" !== typeof field.dataField) {
            var normalizedField = {};
...
function isValidCondition(condition, field) {
    if (field.dataType && "string" !== field.dataType) {
        return "" !== condition[2]
    }
    return true
}
...
function setFocusToBody() {
    if (document.activeElement && "body" !== document.activeElement.nodeName.toLowerCase()) {

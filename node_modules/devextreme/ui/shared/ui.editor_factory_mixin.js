...
var EditorFactoryMixin = function() {
    ...
    var checkEnterBug = function() {
        return browser.msie && parseInt(browser.version) <= 11 || browser.mozilla || devices.real().ios
    };
    var getTextEditorConfig = function(options) {
        ...
        return getResultConfig({
            ...
            onValueChanged: function(e) {
                ...
                if (e.event && "keyup" === e.event.type && !options.updateValueImmediately) {
            ...
            onKeyDown: function(e) {
                if (isEnterBug && isValueChanged && 13 === e.event.keyCode) {
                    isValueChanged = false;
                    options.setValue(e.component.option("value"))
                }
            },
    ...
    var prepareDateBox = function(options) {
        ...
        options.editorOptions = getResultConfig({
            ...
            onKeyDown: function(e) {
                if (checkEnterBug() && 13 === e.event.keyCode) {
                    e.component.blur();
                    e.component.focus()
                }
            },

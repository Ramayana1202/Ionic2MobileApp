...
var subscribeToRowClick = function(that, $table) {
    ...
    eventsEngine.on($table, "dxclick", ".dx-row", {
...
exports.ColumnsView = modules.View.inherit(columnStateMixin).inherit({
    ...
    _createTable: function(columns) {
        ...
        if (that.option("cellHintEnabled")) {
            eventsEngine.on($table, "mousemove", ".dx-row > td", this.createAction(function(args) {
                ...
                if (!isFilterRow && (!isDataRow || isDataRow && column && !column.cellTemplate) && (!isHeaderRow || isHeaderRow && column && !column.headerCellTemplate) && (!isGroupRow || isGroupRow && column && (void 0 === column.groupIndex || !column.groupCellTemplate))) {
    ...
    _processTemplate: function(template) {
        ...
        if (template && template.render && !typeUtils.isRenderer(template)) {
            ...
            if (typeUtils.isFunction(template)) {
                renderingTemplate = {
                    render: function(options) {

...
var LayoutManager = Widget.inherit({
    ...
    _renderFieldItem: function(item, $container) {
        ...
        $container.addClass(FIELD_ITEM_CLASS).addClass(isRequired ? FIELD_ITEM_REQUIRED_CLASS : FIELD_ITEM_OPTIONAL_CLASS).addClass(that.option("cssItemClass")).addClass(typeUtils.isDefined(item.col) ? "dx-col-" + item.col : "");

...
var dropDownAppointments = Class.inherit({
    ...
    _createButtonTemplate: function(appointmentCount) {
        return $("<div>").append([$("<span>").text(messageLocalization.getFormatter("dxScheduler-moreAppointments")(appointmentCount))]).addClass(DROPDOWN_APPOINTMENTS_CONTENT_CLASS)
    },

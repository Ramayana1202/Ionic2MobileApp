...
var VerticalRenderingStrategy = BaseAppointmentsStrategy.inherit({
    ...
    _getAppointmentCount: function(overlappingMode, coordinates) {
        return "auto" !== overlappingMode && 1 === coordinates.count && !isNumeric(overlappingMode) ? coordinates.count : this._getMaxAppointmentCountPerCell()
    },
    _getDefaultRatio: function(coordinates, appointmentCountPerCell) {
        return coordinates.count > APPOINTMENT_COUNT_PER_CELL ? .65 : 1
    },

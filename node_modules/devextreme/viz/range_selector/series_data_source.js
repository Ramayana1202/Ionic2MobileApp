...
SeriesDataSource = function(options) {
    ...
    that._seriesFamilies = processSeriesFamilies(that._series, themeManager.getOptions("equalBarWidth"), themeManager.getOptions("minBubbleSize"), themeManager.getOptions("maxBubbleSize"), themeManager.getOptions("barWidth"), typeUtils.isDefined(negativesAsZeroes) ? negativesAsZeroes : negativesAsZeros)
};

...
function zoomArgsIsEqualCanvas(zoomArgs) {
    ...
    return zoomArgs && valuesIsDefinedAndEqual(businessRange.min, businessRange.max) && _abs(zoomArgs.min - canvasOptions.rangeMin) <= correctionPrecision && _abs(zoomArgs.max - canvasOptions.rangeMax) <= correctionPrecision
}

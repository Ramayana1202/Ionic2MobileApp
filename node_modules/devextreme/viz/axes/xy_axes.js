...
module.exports = {
    linear: {
        ...
        drawScaleBreaks: function(customCanvas) {
            var positionFrom, positionTo, clipRect, breakOptions, that = this,
                options = that._options,
            ...
            if (customCanvas) {
                ...
                positionFrom = that._orthogonalPositions.start - (options.visible && ("left" === position || "top" === position) ? SCALE_BREAK_OFFSET : 0);
            ...
            that._axisBreaksGroup.attr({
                "clip-path": clipRect.id
            });
